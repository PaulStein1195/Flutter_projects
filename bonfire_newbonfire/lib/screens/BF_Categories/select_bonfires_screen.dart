...
import 'bf_sub/nature.dart';
import 'bf_sub/technology.dart';
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Avatar_Widget(context, color1: Colors.redAccent, color2: Colors.red.shade600, text: arts, icon: MyFlutterApp.users,
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
