import 'package:bomfire_v3/controllers/otpController.dart';
...
class _ConfirmNumberPageState extends State<ConfirmNumberPage> {
  ...
  final TextEditingController _numberTextEditController =
                ...
                Container(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("Validate your account", style: TextStyle(
                        ...
                        textField("Your phone number", _numberTextEditController),
                        SizedBox(
                          height: 60,
                        ),
                        Container(
  ...
  Widget button(int index, String text) {
    return SizedBox(
      ...
      child: RaisedButton(
        ...
        //themeCont.theme.value=="dark"?Get.theme.cardColor:Get.theme.focusColor,
        textColor: themeCont.theme.value == "dark"
            ? Get.theme.primaryColorLight
            : Get.theme.primaryColorDark,
      ),
    );
  ...
  Widget textField(
      String hint, TextEditingController numberTextEditController) {
    return TextFormField(
        ...
        style: TextStyle(
            color: themeCont.theme.value == "dark"
                ...
                : Get.theme.primaryColorDark,
            fontSize: 20),
        cursorColor: themeCont.theme.value == "dark"
            ? Get.theme.primaryColorLight
            : Get.theme.primaryColorDark,
        decoration: InputDecoration(
          focusColor: themeCont.theme.value == "dark"
              ? Get.theme.primaryColorLight
              : Get.theme.primaryColorDark,
          fillColor: themeCont.theme.value == "dark"
              ? Get.theme.primaryColorLight
              : Get.theme.primaryColorDark,
